...
MODEL_CONFIG=${MODEL_CONFIG:-"$SCRIPT_DIR/benchmarks/configs/qwen3-0.6b-jq4.json"}
...
--warmup-cases 0 \
--profile-stages \
--output $BENCHMARK_RUN_DIR/qwen06b-single-benchmark.csv \
--jsonl-output $BENCHMARK_RUN_DIR/qwen06b-single-benchmark.jsonl"
