...
MODEL_CONFIG=${MODEL_CONFIG:-"$SCRIPT_DIR/benchmarks/configs/nemotron-labs-diffusion-3b-base-jq4-diffusion.json"}
...
--warmup-cases 0 \
--profile-stages \
--output $BENCHMARK_RUN_DIR/nemotron-diffusion-q4-benchmark.csv \
--jsonl-output $BENCHMARK_RUN_DIR/nemotron-diffusion-q4-benchmark.jsonl"
